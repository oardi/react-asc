...
var Breadcrumb = function (_a) {
    ...
    return (React.createElement("nav", null,
        React.createElement("ol", { className: getCssClasses() }, items && items.map(function (item, index) { return (React.createElement("li", { key: index, className: "breadcrumb-item" + (item.isActive ? ' active' : ''), onClick: function () { return handleClickItem(item); } }, item.isActive ?
            item.label :
