...
var GlobalModal = function (_a) {
    ...
    return (React.createElement(Modal, { header: title, onHeaderCloseClick: onCancel, isDismissable: isDismissable, onBackdropClick: handleClickBackdrop, footer: React.createElement(Fragment, null, buttons.map(function (button, index) { return (React.createElement(Button, { key: index, onClick: function () { return handleClickButton(button); }, variant: button.variant, color: button.color }, button.label)); })) },
