...
var Tabset = function (_a) {
    ...
    return (React.createElement("div", null,
        React.createElement("ul", { className: "nav nav-tabs tabset" }, children.map(function (child) { return (React.createElement("li", { key: child.props.eventKey, className: "nav-item", role: "presentation" },
