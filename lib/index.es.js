...
var AppBar = function (_a) {
    var children = _a.children, _b = _a.color, color = _b === void 0 ? COLOR.primary : _b, _c = _a.shadow, shadow = _c === void 0 ? false : _c;
...
var Button = function (_a) {
    var children = _a.children, _b = _a.block, block = _b === void 0 ? false : _b, _c = _a.color, color = _c === void 0 ? COLOR.primary : _c, _d = _a.disabled, disabled = _d === void 0 ? false : _d, _e = _a.isActive, isActive = _e === void 0 ? false : _e, _f = _a.isRounded, isRounded = _f === void 0 ? false : _f, onClick = _a.onClick, _g = _a.variant, variant = _g === void 0 ? VARIANT.normal : _g, className = _a.className, autoFocus = _a.autofocus, onMouseOver = _a.onMouseOver, onMouseLeave = _a.onMouseLeave;
    var getCssClasses = function () {
        var cssClasses = [];
        cssClasses.push("btn");
    ...
    return (React.createElement("button", { type: "button", className: getCssClasses(), disabled: disabled, autoFocus: autoFocus, onClick: onClick, onMouseOver: onMouseOver, onMouseLeave: onMouseLeave }, children));
};
...
var Tooltip = function (_a) {
    ...
    return (React.createElement(Fragment, null,
        React.createElement("div", { ref: refChild, style: { display: 'inline' } }, cloneElement(children, {
            // onClick: handleClick,
