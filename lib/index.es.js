...
var Checkbox = function (props) {
    ...
    return (React.createElement("div", { className: "checkbox-container" },
        ...
        React.createElement("input", { type: "checkbox", ref: checkboxElement, id: props.id, name: props.name, onChange: handleChange, checked: isChecked, hidden: true, value: props.value, onKeyDown: props.onKeyDown })));
};
