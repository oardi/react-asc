...
var Backdrop = function (_a) {
    ...
    return (createPortal(React.createElement("div", { className: getCssClasses(), onClick: handleClick }), document.body));
};
...
var DropDownMenu = function (_a) {
    ...
    return (React.createElement("div", { className: getCssClasses() },
        ...
        React.createElement(Backdrop, { isTransparent: true, onClick: handleClickItem })));
};
...
var ExpansionPanel = function (_a) {
    ...
    var _b = useState(isExpanded), _isExpanded = _b[0], setIsExpanded = _b[1];
    var handleClickHeader = function () {
        console.warn('handleClickHeader');
        setIsExpanded(!_isExpanded);
    };
    return (React.createElement("div", { className: "expansion-panel" },
