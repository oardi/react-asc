...
var Tabset = function (_a) {
    ...
    var _b = useState(null), navs = _b[0], setNavs = _b[1];
    var _c = useState(null), tabs = _c[0], setTabs = _c[1];
    var _d = useState(null), selectedTabKey = _d[0], setSelectedTabKey = _d[1];
    var getCssClasses = function () {
        var cssClasses = [];
    ...
    return (navs && tabs &&
        React.createElement(React.Fragment, null,
            React.createElement("ul", { className: getCssClasses() }, navs.map(function (nav) { return (React.createElement(TabNav, { key: nav.eventKey, eventKey: nav.eventKey, isActive: nav.eventKey === selectedTabKey, disabled: nav.disabled, onClick: function (eventKey) { return handleClickTab(eventKey); } }, nav.title)); })),
