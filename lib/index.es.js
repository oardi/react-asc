...
var Tabset = function (_a) {
    ...
    var _b = useState(null), selectedTabKey = _b[0], setSelectedTabKey = _b[1];
    var getCssClasses = function () {
        var cssClasses = [];
    ...
    return (children &&
        React.createElement(React.Fragment, null,
            React.createElement("ul", { className: getCssClasses() }, children.map(function (child) { return (React.createElement("li", { key: child.props.eventKey, className: "nav-item" + (child.props.disabled ? ' disabled' : ''), role: "presentation" },
                React.createElement("a", { className: "nav-link" + (child.props.eventKey === selectedTabKey ? ' active' : '') + (child.props.disabled ? ' disabled' : ''), onClick: function () { return handleClickTab(child); } }, child.props.title))); })),
            React.createElement("div", { className: "tab-content" }, children.map(function (child) { return (cloneElement(child, {
