...
var Breadcrumb = function (_a) {
    ...
    return (React.createElement("nav", null,
        React.createElement("ol", { className: getCssClasses() }, items && items.map(function (item) { return (React.createElement("li", { className: "breadcrumb-item" + (item.isActive ? ' active' : ''), onClick: function () { return handleClickItem(item); } }, item.isActive ?
            item.label :
...
var Tabset = function (_a) {
    ...
    return (React.createElement("div", null,
        React.createElement("ul", { className: getCssClasses() }, children.map(function (child) { return (React.createElement("li", { key: child.props.eventKey, className: "nav-item", role: "presentation" },
