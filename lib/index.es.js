import React, { useState, useRef, useEffect, Fragment, createContext, useContext, cloneElement, createRef, Component } from 'react';
...
var AppBar = function (props) {
    var children = props.children, _a = props.color, color = _a === void 0 ? COLOR.primary : _a, _b = props.shadow, shadow = _b === void 0 ? false : _b, rest = __rest(props, ["children", "color", "shadow"]);
    ...
    return (React.createElement("nav", __assign({ className: getCssClasses() }, rest), children));
};

var AppBarTitle = function (_a) {
    var children = _a.children, onClick = _a.onClick;
    return (React.createElement("div", { className: "navbar-brand w-100", onClick: function () { return onClick && onClick(); } }, children));
};
...
var Button = function (props) {
    var children = props.children, _a = props.variant, variant = _a === void 0 ? VARIANT.normal : _a, _b = props.color, color = _b === void 0 ? COLOR.primary : _b, block = props.block, isRounded = props.isRounded, isActive = props.isActive, className = props.className, rest = __rest(props, ["children", "variant", "color", "block", "isRounded", "isActive", "className"]);
    var getCssClasses = function () {
        var cssClasses = [];
        cssClasses.push("btn");
    ...
    return (React.createElement("button", __assign({ type: "button", className: getCssClasses() }, rest), children));
};
...
var Breadcrumb = function (_a) {
    ...
    return (React.createElement("nav", null,
        React.createElement("ol", { className: getCssClasses() }, items && items.map(function (item, index) { return (React.createElement("li", { key: index, className: "breadcrumb-item" + (item.isActive ? ' active' : ''), onClick: function () { return handleClickItem(item); } },
            React.createElement(ConditionalWrapper, { condition: !item.isActive, wrapper: function (label) { return React.createElement("a", null, label); } }, item.label))); }))));
};
...
var IconButton = function (props) {
    var children = props.children, icon = props.icon, _a = props.variant, variant = _a === void 0 ? VARIANT.normal : _a, _b = props.color, color = _b === void 0 ? COLOR.primary : _b, isActive = props.isActive, className = props.className, rest = __rest(props, ["children", "icon", "variant", "color", "isActive", "className"]);
    var getCssClasses = function () {
        var cssClasses = [];
        cssClasses.push("btn");
    ...
    return (React.createElement("button", __assign({ type: "button", className: getCssClasses() }, rest),
...
var Checkbox = function (props) {
    ...
    return (React.createElement("div", { className: "checkbox-container" },
        ...
        React.createElement("input", __assign({ type: "checkbox", ref: checkboxElement, id: id, name: name, checked: isChecked, hidden: true, value: value }, rest))));
};
...
var DropDownMenu = function (_a) {
    ...
    return (React.createElement("div", { className: getCssClasses() }, children &&
        React.Children.map(children, function (child) { return (React.cloneElement(child, {
            onClick: function (e) {
...
var DropDown = function (_a) {
    ...
    var dropDownMenuConainter = useRef();
    var dropDownContext = {
        isShow: isShow,
        setIsShow: setIsShow
    };
        ...
        React.createElement("div", { ref: dropDownMenuConainter, className: "dropdown" },
            ...
            isShow &&
                React.createElement(Fragment, null,
                    ...
                    React.createElement(Backdrop, { target: dropDownMenuConainter.current, isTransparent: true, onClick: function () { return setIsShow(false); } })))));
};
...
var DropDownItem = function (_a) {
    ...
    return (React.createElement(ConditionalWrapper, { condition: true, wrapper: function (children) { return ((type === 'item' ? (React.createElement("a", { className: getCssClasses(), onClick: handleClick }, children)) :
...
var SvgIcon = function (props) {
    ...
    return (React.createElement("div", __assign({ className: getCssClasses(), dangerouslySetInnerHTML: { __html: svg } }, rest)));
};
...
var ExpansionPanelHeader = function (_a) {
    ...
    return (React.createElement("div", { className: "expansion-panel-header d-flex align-items-center", onClick: handleClick },
        ...
        React.createElement("span", { className: "ml-auto text-muted" },
            React.createElement(SvgIcon, { svg: isExpanded ? chevronUpSolidSvg : chevronDownSolidSvg }))));
};

var ExpansionPanel = function (_a) {
    var header = _a.header, children = _a.children, isExpanded = _a.isExpanded, onChange = _a.onChange;
    var _b = useState(false), _isExpanded = _b[0], setIsExpanded = _b[1];
    useEffect(function () {
...
var FormInput = function (_a) {
    ...
    ,
        ...
        type === 'radio' &&
            React.createElement(Fragment, null, options.map(function (option) {
...
var List = function (_a) {
    ...
    var _d = useState(null), listItems = _d[0], setListItems = _d[1];
    useEffect(function () {
        if (children) {
    ...
    return (React.createElement("ul", { className: getCssClasses() }, listItems && listItems.map(function (listItem, index) { return (cloneElement(listItem, {
...
var GlobalModal = function (_a) {
    ...
    var _d = useState(null), myControls = _d[0], setMyControls = _d[1];
    useEffect(function () {
    ...
    ModalService.prototype.show = function (title, description, options) {
        ...
        if (!this.container) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                render(React.createElement(GlobalModal, { title: title, description: description, formControls: options && options.formControls, onCancel: handleCancel, onOk: handleOk, isDismissable: options && options.isDismissable, buttons: options && options.buttons }), _this.container);
            });
        }
    };
...
var Snackbar = function (_a) {
    var message = _a.message, _b = _a.color, color = _b === void 0 ? COLOR.dark : _b, _c = _a.actionText, actionText = _c === void 0 ? 'ok' : _c, onOk = _a.onOk;
    var getCssClasses = function () {
        var cssClasses = [];
...
var SnackbarService = /** @class */ (function () {
    ...
    SnackbarService.prototype.show = function (message, options) {
        var _this = this;
        var defaultOptions = { timeout: 3000, actionText: 'ok', color: COLOR.dark };
        ...
        return new Promise(function (resolve, reject) {
            ...
            render(React.createElement(Snackbar, { message: message, color: mergedOptions.color, actionText: mergedOptions.actionText, onOk: handleOk }), _this.container);
        });
    };
...
var Table = function (_a) {
    ...
    return (React.createElement(ConditionalWrapper, { condition: responsive, wrapper: function (children) { return React.createElement("div", { className: "table-responsive" }, children); } },
...
var TabNav = function (_a) {
    ...
    return (React.createElement("li", { key: eventKey, className: "nav-item" + (disabled ? ' disabled' : '') },
        React.createElement("a", { className: "nav-link" + (isActive ? ' active' : '') + (disabled ? ' disabled' : ''), onClick: function () { return !disabled && onClick && onClick(eventKey); } }, children)));
};
...
var Tabset = function (_a) {
    ...
    var _b = useState(selectedEventKey), _selectedEventKey = _b[0], setSelectedEventKey = _b[1];
    var _c = useState(null), navs = _c[0], setNavs = _c[1];
    var _d = useState(null), tabs = _d[0], setTabs = _d[1];
    var getCssClasses = function () {
        var cssClasses = [];
    ...
    return (navs && tabs &&
        React.createElement(Fragment, null,
            React.createElement("ul", { className: getCssClasses() }, navs.map(function (nav) { return (React.createElement(TabNav, { key: nav.eventKey, eventKey: nav.eventKey, isActive: nav.eventKey === _selectedEventKey, disabled: nav.disabled, onClick: function (eventKey) { return handleClickTab(eventKey); } }, nav.title)); })),
            React.createElement("div", { className: "tab-content" }, tabs.map(function (tab) { return (cloneElement(tab, {
...
export { AppBar, AppBarTitle, Backdrop, Breadcrumb, Button, COLOR, Card, CardBody, CardFooter, CardSubtitle, CardText, CardTitle, Checkbox, ConditionalWrapper, Drawer, DropDown, DropDownDivider, DropDownItem, DropDownMenu, DropDownToggle, EmailValidator, ExpansionPanel, ExpansionPanelContent, ExpansionPanelHeader, Form, FormControl, FormError, FormGroup, FormHint, FormInput, FormLabel, FormOld, GlobalModal, IconButton, IsEmptyValidator, List, ListItem, ListItemAction, ListItemAvatar, ListItemText, LogType, MODALBUTTONTYPE, MODALTYPE, Modal, ModalBody, ModalFooter, ModalHeader, POSITION, SIZE, Sidebar, Snackbar, SvgIcon, Tab, Table, Tabset, Tooltip, TreeView, VARIANT, checkSquareRegularSvg, chevronDownSolidSvg, chevronRightSolidSvg, chevronUpSolidSvg, homeSolid as homeSolidSvg, loggerService, modalService, snackbarService, squareRegularSvg };
