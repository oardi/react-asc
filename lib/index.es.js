...
var Button = function (props) {
    var children = props.children, _a = props.variant, variant = _a === void 0 ? VARIANT.text : _a, _b = props.color, color = _b === void 0 ? COLOR.primary : _b, block = props.block, isRounded = props.isRounded, isActive = props.isActive, className = props.className, rest = __rest(props, ["children", "variant", "color", "block", "isRounded", "isActive", "className"]);
    var getCssClasses = function () {
        var cssClasses = [];
        cssClasses.push("btn");
...
var IconButton = function (props) {
    var children = props.children, icon = props.icon, _a = props.variant, variant = _a === void 0 ? VARIANT.text : _a, _b = props.color, color = _b === void 0 ? COLOR.primary : _b, isActive = props.isActive, className = props.className, rest = __rest(props, ["children", "icon", "variant", "color", "isActive", "className"]);
    var getCssClasses = function () {
        var cssClasses = [];
        cssClasses.push("btn");
