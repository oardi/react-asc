...
var Button = function (_a) {
    var children = _a.children, _b = _a.block, block = _b === void 0 ? false : _b, _c = _a.color, color = _c === void 0 ? COLOR.primary : _c, _d = _a.disabled, disabled = _d === void 0 ? false : _d, _e = _a.isActive, isActive = _e === void 0 ? false : _e, _f = _a.isRounded, isRounded = _f === void 0 ? false : _f, onClick = _a.onClick, _g = _a.variant, variant = _g === void 0 ? VARIANT.normal : _g, className = _a.className, autoFocus = _a.autofocus;
    var getCssClasses = function () {
        var cssClasses = [];
        cssClasses.push("btn");
    ...
    return (React.createElement("button", { type: "button", className: getCssClasses(), disabled: disabled, onClick: function (e) { return handleClick(e); }, autoFocus: autoFocus }, children));
};
...
var Tooltip = function (_a) {
    ...
    // bs-tooltip-bottom
    // bs-tooltip-right
    return (React.createElement("div", { className: "tooltip fade bs-tooltip-top show", style: {
            position: 'absolute',
            top: '0px',
            left: '0px',
            willChange: 'transform'
        } },
        React.createElement("div", { className: "arrow", style: { left: '45px' } }),
        React.createElement("div", { className: "tooltip-inner" }, children)));
};
