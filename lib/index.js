...
const Checkbox = (props) => {
    ...
    const icons = {
        default: React__default['default'].createElement(SvgSquareRegular, null),
        selected: React__default['default'].createElement(SvgCheckSquareRegular, null)
    };
    const getCssClasses = () => {
        const cssClasses = [];
...
const ExpansionPanelHeader = (props) => {
    ...
    return (React__default['default'].createElement("div", { className: "expansion-panel-header d-flex align-items-center", onClick: handleClick },
        ...
        React__default['default'].createElement("span", { className: "ml-auto text-muted" },
            React__default['default'].createElement(SvgIcon, null, isExpanded ? React__default['default'].createElement(SvgChevronUpSolid, null) : React__default['default'].createElement(SvgChevronDownSolid, null)))));
};
...
const TreeNode = (props) => {
    ...
    return (React__default['default'].createElement("li", { className: "tree-node", style: { paddingLeft: `${40 * level}px` } },
        hasChildren ?
            React__default['default'].createElement(IconButton, { className: "btn-toggle", onClick: () => onClick(id), icon: !isExpanded ? React__default['default'].createElement(SvgChevronRightSolid, null) : React__default['default'].createElement(SvgChevronDownSolid, null) })
            :
...
exports.CheckSquareRegularSvg = SvgCheckSquareRegular;
exports.Checkbox = Checkbox;
exports.ChevronDownSolidSvg = SvgChevronDownSolid;
exports.ChevronRightSolidSvg = SvgChevronRightSolid;
exports.ChevronUpSolidSvg = SvgChevronUpSolid;
...
exports.HomeSolidSvg = SvgHomeSolid;
...
exports.SquareRegularSvg = SvgSquareRegular;
