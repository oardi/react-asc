...
var Tabset = function (_a) {
    var children = _a.children, className = _a.className, onTabSelect = _a.onTabSelect;
    var _b = React.useState(null), selectedTabKey = _b[0], setSelectedTabKey = _b[1];
    var getCssClasses = function () {
        var cssClasses = [];
    ...
    React.useEffect(function () {
        if (children) {
            var activeChild = children.find(function (child) { return child.props.isActive && !child.props.disabled; });
            if (activeChild) {
    ...
    return (children &&
        React__default['default'].createElement(React__default['default'].Fragment, null,
            React__default['default'].createElement("ul", { className: getCssClasses() }, children.map(function (child) { return (React__default['default'].createElement("li", { key: child.props.eventKey, className: "nav-item" + (child.props.disabled ? ' disabled' : ''), role: "presentation" },
                React__default['default'].createElement("a", { className: "nav-link" + (child.props.eventKey === selectedTabKey ? ' active' : '') + (child.props.disabled ? ' disabled' : ''), onClick: function () { return handleClickTab(child); } }, child.props.title))); })),
            React__default['default'].createElement("div", { className: "tab-content" }, children.map(function (child) { return (React.cloneElement(child, {
