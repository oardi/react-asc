...
var AppBar = function (props) {
    var children = props.children, _a = props.color, color = _a === void 0 ? exports.COLOR.primary : _a, _b = props.shadow, shadow = _b === void 0 ? false : _b, rest = __rest(props, ["children", "color", "shadow"]);
    ...
    return (React__default['default'].createElement("nav", __assign({ className: getCssClasses() }, rest), children));
};

var AppBarTitle = function (_a) {
    var children = _a.children, onClick = _a.onClick;
    return (React__default['default'].createElement("div", { className: "navbar-brand w-100", onClick: function () { return onClick && onClick(); } }, children));
};

var Backdrop = function (_a) {
    var _b = _a.target, target = _b === void 0 ? document.body : _b, _c = _a.isTransparent, isTransparent = _c === void 0 ? false : _c, onClick = _a.onClick;
...
var Button = function (props) {
    var children = props.children, _a = props.variant, variant = _a === void 0 ? exports.VARIANT.normal : _a, _b = props.color, color = _b === void 0 ? exports.COLOR.primary : _b, block = props.block, isRounded = props.isRounded, isActive = props.isActive, className = props.className, rest = __rest(props, ["children", "variant", "color", "block", "isRounded", "isActive", "className"]);
    var getCssClasses = function () {
        var cssClasses = [];
        cssClasses.push("btn");
    ...
    return (React__default['default'].createElement("button", __assign({ type: "button", className: getCssClasses() }, rest), children));
};
...
var Breadcrumb = function (_a) {
    var className = _a.className, items = _a.items, onItemClick = _a.onItemClick;
    var getCssClasses = function () {
        var cssClasses = [];
    ...
    return (React__default['default'].createElement("nav", null,
        React__default['default'].createElement("ol", { className: getCssClasses() }, items && items.map(function (item, index) { return (React__default['default'].createElement("li", { key: index, className: "breadcrumb-item" + (item.isActive ? ' active' : ''), onClick: function () { return handleClickItem(item); } },
            React__default['default'].createElement(ConditionalWrapper, { condition: !item.isActive, wrapper: function (label) { return React__default['default'].createElement("a", null, label); } }, item.label))); }))));
};
...
var IconButton = function (props) {
    var children = props.children, icon = props.icon, _a = props.variant, variant = _a === void 0 ? exports.VARIANT.normal : _a, _b = props.color, color = _b === void 0 ? exports.COLOR.primary : _b, isActive = props.isActive, className = props.className, rest = __rest(props, ["children", "icon", "variant", "color", "isActive", "className"]);
    var getCssClasses = function () {
        var cssClasses = [];
        cssClasses.push("btn");
    ...
    return (React__default['default'].createElement("button", __assign({ type: "button", className: getCssClasses() }, rest),
        React__default['default'].createElement("span", { className: "svg-icon", dangerouslySetInnerHTML: { __html: icon } })));
};

var Checkbox = function (props) {
    var id = props.id, checked = props.checked, className = props.className, label = props.label, name = props.name, _a = props.value, value = _a === void 0 ? "off" : _a, rest = __rest(props, ["id", "checked", "className", "label", "name", "value"]);
    // TODO
    // add own value
    // set from outer
    // update on change
    ...
    return (React__default['default'].createElement("div", { className: "checkbox-container" },
        ...
        React__default['default'].createElement("input", __assign({ type: "checkbox", ref: checkboxElement, id: id, name: name, checked: isChecked, hidden: true, value: value }, rest))));
};
...
var DropDownMenu = function (_a) {
    var children = _a.children, className = _a.className, _b = _a.menuPosition, menuPosition = _b === void 0 ? 'left' : _b;
    ...
    return (React__default['default'].createElement("div", { className: getCssClasses() }, children &&
        React__default['default'].Children.map(children, function (child) { return (React__default['default'].cloneElement(child, {
            onClick: function (e) {
...
var DropDown = function (_a) {
    var toggle = _a.toggle, children = _a.children, menuPosition = _a.menuPosition, onToggleClick = _a.onToggleClick;
    var _b = React.useState(false), isShow = _b[0], setIsShow = _b[1];
    var dropDownMenuConainter = React.useRef();
    var dropDownContext = {
        isShow: isShow,
        setIsShow: setIsShow
    };
        ...
        React__default['default'].createElement("div", { ref: dropDownMenuConainter, className: "dropdown" },
            ...
            isShow &&
                React__default['default'].createElement(React.Fragment, null,
                    ...
                    React__default['default'].createElement(Backdrop, { target: dropDownMenuConainter.current, isTransparent: true, onClick: function () { return setIsShow(false); } })))));
};

var DropDownItem = function (_a) {
    var children = _a.children, onClick = _a.onClick, _b = _a.type, type = _b === void 0 ? 'item' : _b;
    var getCssClasses = function () {
        var cssClasses = [];
        if (type === 'header') {
    ...
    return (React__default['default'].createElement(ConditionalWrapper, { condition: true, wrapper: function (children) { return ((type === 'item' ? (React__default['default'].createElement("a", { className: getCssClasses(), onClick: handleClick }, children)) :
...
var DropDownDivider = function () { return React__default['default'].createElement("div", { className: "dropdown-divider" }); };

var ExpansionPanelContent = function (_a) {
    var children = _a.children;
    return (React__default['default'].createElement("div", { className: "expansion-panel-content" }, children));
};

var SvgIcon = function (props) {
    var svg = props.svg, rest = __rest(props, ["svg"]);
    var getCssClasses = function () {
        var cssClasses = [];
    ...
    return (React__default['default'].createElement("div", __assign({ className: getCssClasses(), dangerouslySetInnerHTML: { __html: svg } }, rest)));
};

var ExpansionPanelHeader = function (_a) {
    var children = _a.children, isExpanded = _a.isExpanded, onClick = _a.onClick;
    var handleClick = function (e) {
        e.stopPropagation();
        onClick && onClick(e);
    };
...
var ExpansionPanel = function (_a) {
    var header = _a.header, children = _a.children, isExpanded = _a.isExpanded, onChange = _a.onChange;
    var _b = React.useState(false), _isExpanded = _b[0], setIsExpanded = _b[1];
    React.useEffect(function () {
...
var FormInput = function (_a) {
    ...
    ,
        ...
        type === 'radio' &&
            React__default['default'].createElement(React.Fragment, null, options.map(function (option) {
    ...
    Form.prototype.handleChange = function () {
        ...
        if (this.state.isChanged || this.state.isSubmitted) {
            ...
            var values = keys.reduce(function (obj, f) {
                ...
                // TODO - refactor
                var newValue = ((control.type === 'date' || control.type === 'datetime-local') && control.value && isValidDate(control.value)) ? new Date(control.value).toISOString() : control.value;
...
var List = function (_a) {
    var children = _a.children, _b = _a.isFlush, isFlush = _b === void 0 ? false : _b, _c = _a.isHoverable, isHoverable = _c === void 0 ? true : _c;
    var _d = React.useState(null), listItems = _d[0], setListItems = _d[1];
    React.useEffect(function () {
        if (children) {
            if (Array.isArray(children)) {
                setListItems(children.map(function (child) { return new ListItemModel(child); }));
            }
            else {
    ...
    return (React__default['default'].createElement("ul", { className: getCssClasses() }, listItems && listItems.map(function (listItem, index) { return (React.cloneElement(listItem, {
...
var GlobalModal = function (_a) {
    var title = _a.title, description = _a.description, formControls = _a.formControls, onOk = _a.onOk, onCancel = _a.onCancel, _b = _a.isDismissable, isDismissable = _b === void 0 ? false : _b, _c = _a.buttons, buttons = _c === void 0 ? [
        { label: 'cancel', type: exports.MODALBUTTONTYPE.CANCEL, color: exports.COLOR.secondary, variant: exports.VARIANT.text, focus: true },
        { label: 'ok', type: exports.MODALBUTTONTYPE.OK },
    ] : _c;
    // workaround for getDerivedStateFromProps
    var _d = React.useState(null), myControls = _d[0], setMyControls = _d[1];
    React.useEffect(function () {
    ...
    var handleClickButton = function (button) {
        switch (button.type) {
    ...
    return (React__default['default'].createElement(Modal, { header: title, onHeaderCloseClick: onCancel, isDismissable: isDismissable, onBackdropClick: handleClickBackdrop, footer: React__default['default'].createElement(React.Fragment, null, buttons.map(function (button, index) { return (React__default['default'].createElement(Button, { key: index, variant: button.variant, color: button.color, autoFocus: button.autoFocus, onClick: function () { return handleClickButton(button); } }, button.label)); })) },
    ...
    ModalService.prototype.show = function (title, description, options) {
        ...
        if (!this.container) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                reactDom.render(React__default['default'].createElement(GlobalModal, { title: title, description: description, formControls: options && options.formControls, onCancel: handleCancel, onOk: handleOk, isDismissable: options && options.isDismissable, buttons: options && options.buttons }), _this.container);
            });
        }
    };
...
var Sidebar = function (_a) {
    var items = _a.items, currentUrl = _a.currentUrl, onItemClicked = _a.onItemClicked;
    ...
    return (React__default['default'].createElement("nav", { className: "sidebar navbar navbar-expand-lg align-items-start" },
        React__default['default'].createElement(List, null, menuItems.map(function (item) {
            return React__default['default'].createElement(ListItem, { key: item.id, onClick: function (e) { return navigate(e, "/" + item.path); } },
                React__default['default'].createElement("div", { className: "d-flex flex-column w-100" },
                    item.label,
                    item.items &&
                        React__default['default'].createElement(List, null, item.items.map(function (subItem) { return (React__default['default'].createElement(ListItem, { key: subItem.id, onClick: function (e) { return navigate(e, "/" + item.path + "/" + subItem.path); } }, subItem.label)); }))));
        }))));
};

var Snackbar = function (_a) {
    var message = _a.message, _b = _a.color, color = _b === void 0 ? exports.COLOR.dark : _b, _c = _a.actionText, actionText = _c === void 0 ? 'ok' : _c, onOk = _a.onOk;
    var getCssClasses = function () {
        var cssClasses = [];
...
var SnackbarService = /** @class */ (function () {
    ...
    SnackbarService.prototype.show = function (message, options) {
        var _this = this;
        var defaultOptions = { timeout: 3000, actionText: 'ok', color: exports.COLOR.dark };
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.container.classList.add('snackbar-container');
            ...
            reactDom.render(React__default['default'].createElement(Snackbar, { message: message, color: mergedOptions.color, actionText: mergedOptions.actionText, onOk: handleOk }), _this.container);
        });
    };
...
var Table = function (_a) {
    var children = _a.children, className = _a.className, bordered = _a.bordered, striped = _a.striped, hover = _a.hover, responsive = _a.responsive;
    var getCssClasses = function () {
        var cssClasses = [];
    ...
    return (React__default['default'].createElement(ConditionalWrapper, { condition: responsive, wrapper: function (children) { return React__default['default'].createElement("div", { className: "table-responsive" }, children); } },
        React__default['default'].createElement("table", { className: getCssClasses() }, children)));
};

var TabNavModel = /** @class */ (function () {
    function TabNavModel(dto) {
...
var TabModel = /** @class */ (function () {
    function TabModel(dto) {
        return __assign({}, dto);
    }
    return TabModel;
}());

var TabNav = function (_a) {
    var eventKey = _a.eventKey, disabled = _a.disabled, children = _a.children, isActive = _a.isActive, onClick = _a.onClick;
    return (React__default['default'].createElement("li", { key: eventKey, className: "nav-item" + (disabled ? ' disabled' : '') },
        React__default['default'].createElement("a", { className: "nav-link" + (isActive ? ' active' : '') + (disabled ? ' disabled' : ''), onClick: function () { return !disabled && onClick && onClick(eventKey); } }, children)));
};

var Tabset = function (_a) {
    var children = _a.children, className = _a.className, fill = _a.fill, onTabSelect = _a.onTabSelect, selectedEventKey = _a.selectedEventKey;
    var _b = React.useState(selectedEventKey), _selectedEventKey = _b[0], setSelectedEventKey = _b[1];
    var _c = React.useState(null), navs = _c[0], setNavs = _c[1];
    var _d = React.useState(null), tabs = _d[0], setTabs = _d[1];
    var getCssClasses = function () {
        var cssClasses = [];
    ...
    React.useEffect(function () {
        if (children) {
            if (Array.isArray(children)) {
                setTabs(children.map(function (child) { return new TabModel(child); }));
                setNavs(children.map(function (child) { return new TabNavModel(child); }));
            }
            else {
    ...
    React.useEffect(function () {
        if (tabs && tabs.length > 0) {
            var activeTab = tabs.find(function (tab) { return tab.props.eventKey === _selectedEventKey; });
            if (activeTab) {
    ...
    return (navs && tabs &&
        React__default['default'].createElement(React.Fragment, null,
            React__default['default'].createElement("ul", { className: getCssClasses() }, navs.map(function (nav) { return (React__default['default'].createElement(TabNav, { key: nav.eventKey, eventKey: nav.eventKey, isActive: nav.eventKey === _selectedEventKey, disabled: nav.disabled, onClick: function (eventKey) { return handleClickTab(eventKey); } }, nav.title)); })),
            React__default['default'].createElement("div", { className: "tab-content" }, tabs.map(function (tab) { return (React.cloneElement(tab, {
...
var Tab = function (_a) {
    var children = _a.children, className = _a.className, isActive = _a.isActive;
    var getCssClasses = function () {
        var cssClasses = [];
...
var Tooltip = function (_a) {
    var children = _a.children, text = _a.text, _b = _a.placement, placement = _b === void 0 ? 'left' : _b;
    var _c = React.useState(false), show = _c[0], setShow = _c[1];
    var refChild = React.useRef();
    var refTooltip = React.useRef();
    React.useEffect(function () {
        if (show === true) {
