...
var Backdrop = function (_a) {
    var _b = _a.isTransparent, isTransparent = _b === void 0 ? false : _b, onClick = _a.onClick;
    ...
    return (reactDom.createPortal(React__default['default'].createElement("div", { className: getCssClasses(), onClick: handleClick }), document.body));
};
...
var DropDownMenu = function (_a) {
    ...
    return (React__default['default'].createElement("div", { className: getCssClasses() },
        ...
        React__default['default'].createElement(Backdrop, { isTransparent: true, onClick: handleClickItem })));
};
...
var ExpansionPanel = function (_a) {
    var header = _a.header, children = _a.children, isExpanded = _a.isExpanded;
    var _b = React.useState(isExpanded), _isExpanded = _b[0], setIsExpanded = _b[1];
    var handleClickHeader = function () {
        console.warn('handleClickHeader');
        setIsExpanded(!_isExpanded);
    };
    return (React__default['default'].createElement("div", { className: "expansion-panel" },
