...
var Backdrop = function (_a) {
    ...
    return (reactDom.createPortal(React__default['default'].createElement("div", { className: "modal-backdrop fade show", onClick: handleClick }), document.body));
};
...
var DropDownMenu = function (_a) {
    ...
    return (React__default['default'].createElement("div", { className: getCssClasses() },
        ...
        React__default['default'].createElement(Backdrop, { onClick: handleClickItem })));
};
