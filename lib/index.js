...
var css_248z$4 = ".AppBar-module_appbar__1S8G1 {\n  padding: 0.5rem 1rem;\n  display: flex; }\n  .AppBar-module_appbar__1S8G1.AppBar-module_primary__3CiO7 {\n    color: var(--primary-contrast-text);\n    background-color: var(--primary); }\n  .AppBar-module_appbar__1S8G1.AppBar-module_shadow__2c8iH {\n    box-shadow: var(--shadow); }\n";
var styles$4 = {"appbar":"AppBar-module_appbar__1S8G1","primary":"AppBar-module_primary__3CiO7","shadow":"AppBar-module_shadow__2c8iH"};
...
const AppBar = (props) => {
    ...
    const getCssClasses = () => {
        const result = [];
        result.push(styles$4[color]);
        result.push(styles$4.appbar);
        if (shadow)
            result.push(styles$4['shadow']);
        return result.filter(r => r).join(' ');
    };
    return (React.createElement("nav", Object.assign({ className: getCssClasses() }, rest), children));
};

var css_248z$3 = ".AppBarTitle-module_appbarTitle__3J-Z1 {\n  display: inline-block;\n  padding-top: 0.3125rem;\n  padding-bottom: 0.3125rem;\n  margin-right: 1rem;\n  font-size: 1.25rem;\n  line-height: inherit;\n  white-space: nowrap; }\n  .AppBarTitle-module_appbarTitle__3J-Z1 h1 {\n    margin-bottom: 0;\n    font-size: 20px;\n    font-weight: 400;\n    line-height: 30px; }\n";
var styles$3 = {"appbarTitle":"AppBarTitle-module_appbarTitle__3J-Z1"};
...
const AppBarTitle = (props) => {
    ...
    const getCssClass = () => {
        ...
        result.push(styles$3.appbarTitle);
        return result.filter(r => r).join(' ');
    };
...
var css_248z$2 = ".Card-module_card__31o3Z {\n  background: var(--white);\n  border-radius: var(--borderRadius); }\n  .Card-module_card__31o3Z.Card-module_shadow__2lpYq {\n    box-shadow: var(--shadow); }\n";
var styles$2 = {"card":"Card-module_card__31o3Z","shadow":"Card-module_shadow__2lpYq"};
...
const Card = (props) => {
    ...
    const getCssClasses = () => {
        const cssClasses = [];
        cssClasses.push(styles$2.card);
        shadow && cssClasses.push(styles$2.shadow);
        cssClasses.push(className);
        return cssClasses.filter(css => css).join(' ');
    };
...
var css_248z$1 = ".CardBody-module_cardBody__N8z-L {\n  flex: 1 1 auto;\n  min-height: 1px;\n  padding: 1.25rem; }\n";
var styles$1 = {"cardBody":"CardBody-module_cardBody__N8z-L"};
styleInject(css_248z$1);

const CardBody = (_a) => {
    var { children } = _a, rest = __rest(_a, ["children"]);
    return (React.createElement("div", Object.assign({ className: styles$1.cardBody }, rest), children));
};
...
var css_248z = ".CardTitle-module_cardTitle__24Amb {\n  margin-bottom: .75rem;\n  font-size: 1.5rem;\n  font-weight: 400;\n  line-height: 1.334;\n  letter-spacing: 0em; }\n";
var styles = {"cardTitle":"CardTitle-module_cardTitle__24Amb"};
