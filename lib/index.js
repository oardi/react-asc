...
const FormInput = (props) => {
    ...
    return (React.createElement(Fragment, null,
        ...
        type === 'select' &&
            React.createElement("select", { id: name, name: name, className: className + (!isValid ? ' is-invalid' : ''), value: value, autoFocus: autoFocus, multiple: selectOptions === null || selectOptions === void 0 ? void 0 : selectOptions.multiple, onChange: onChange, onKeyDown: onKeyDown },
