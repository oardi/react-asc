...
var Tabset = function (_a) {
    ...
    return (React__default['default'].createElement("div", null,
        React__default['default'].createElement("ul", { className: "nav nav-tabs tabset" }, children.map(function (child) { return (React__default['default'].createElement("li", { key: child.props.eventKey, className: "nav-item", role: "presentation" },
