...
var IconButton = function (props) {
    var children = props.children, icon = props.icon, _a = props.variant, variant = _a === void 0 ? exports.VARIANT.text : _a, _b = props.color, color = _b === void 0 ? exports.COLOR.primary : _b, isActive = props.isActive, className = props.className, rest = __rest(props, ["children", "icon", "variant", "color", "isActive", "className"]);
    var getCssClasses = function () {
        var cssClasses = [];
        cssClasses.push("btn");
