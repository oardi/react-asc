...
var SnackbarService = /** @class */ (function () {
    ...
    SnackbarService.prototype.show = function (message, options) {
        var _this = this;
        if (options === void 0) { options = { timeout: 3000, actionText: 'ok', color: exports.COLOR.dark }; }
        return new Promise(function (resolve, reject) {
            if (_this.container) {
                _this.hide();
            }
            ...
            reactDom.render(React__default['default'].createElement(Snackbar, { message: message, color: options.color, actionText: options.actionText, onOk: handleOk }), _this.container);
        });
    };
