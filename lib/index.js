...
var css_248z$i = ".AppBar-module_appbar__1S8G1 {\n  padding: 0.5rem 1rem;\n  display: flex; }\n  .AppBar-module_appbar__1S8G1.AppBar-module_primary__3CiO7 {\n    color: var(--primary-contrast-text);\n    background-color: var(--primary); }\n  .AppBar-module_appbar__1S8G1.AppBar-module_shadow__2c8iH {\n    box-shadow: var(--shadow); }\n";
var styles$i = {"appbar":"AppBar-module_appbar__1S8G1","primary":"AppBar-module_primary__3CiO7","shadow":"AppBar-module_shadow__2c8iH"};
...
var css_248z$h = ".AppBarTitle-module_appbarTitle__3J-Z1 {\n  display: flex;\n  align-items: center;\n  padding-top: 0.3125rem;\n  padding-bottom: 0.3125rem;\n  margin-right: 1rem;\n  font-size: 1.25rem;\n  line-height: inherit;\n  white-space: nowrap; }\n  .AppBarTitle-module_appbarTitle__3J-Z1 h1 {\n    margin-bottom: 0;\n    font-size: 20px;\n    font-weight: 400;\n    line-height: 30px; }\n";
var styles$h = {"appbarTitle":"AppBarTitle-module_appbarTitle__3J-Z1"};
...
const AppBarTitle = (props) => {
    ...
    const getCssClass = () => {
        ...
        result.push(styles$h.appbarTitle);
        return result.filter(r => r).join(' ');
    };
...
const Breadcrumb = (props) => {
    ...
    return (React.createElement(React.Fragment, null, items && items.length > 0 &&
        React.createElement("nav", null,
            React.createElement("ol", { className: getCssClasses() }, items.map((item, index) => (React.createElement("li", { key: index, className: styles$g.breadcrumbItem + (item.isActive ? ' active' : ''), onClick: () => handleClickItem(item) },
...
const CardBody = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: styles$e.cardBody }, rest), children));
};
...
var css_248z$d = ".CardTitle-module_cardTitle__24Amb {\n  margin-bottom: 0;\n  font-size: 1.5rem;\n  font-weight: 400;\n  line-height: 1.334;\n  letter-spacing: 0em; }\n";
var styles$d = {"cardTitle":"CardTitle-module_cardTitle__24Amb"};
...
const IconButton = (props) => {
    ...
    const getCssClasses = () => {
        ...
        cssClasses.push(styles$c[variant]);
        cssClasses.push(styles$c.iconButton);
        isActive && cssClasses.push(styles$c.active);
...
var css_248z$b = ".Checkbox-module_checkboxContainer__2oWhu {\n  display: flex;\n  align-items: center; }\n  .Checkbox-module_checkboxContainer__2oWhu label {\n    margin-bottom: 0;\n    margin-left: 0; }\n    .Checkbox-module_checkboxContainer__2oWhu label:hover {\n      cursor: pointer; }\n";
var styles$b = {"checkboxContainer":"Checkbox-module_checkboxContainer__2oWhu"};
...
const Chip = (props) => {
    ...
    const getCssClass = () => {
        const result = [];
        result.push(styles$a.chip);
        result.push(styles$a[color]);
        shadow && result.push(styles$a['shadow']);
        onClick && result.push(styles$a['clickable']);
        result.push(className);
        return result.filter(r => r).join(' ');
    };
    ...
    return (React.createElement("div", Object.assign({ className: getCssClass() }, rest, { style: style }),
        ...
        onDelete && (React.createElement("div", { className: styles$a.deleteIcon, onClick: e => handleClickOnDelete(e) }, deleteIcon))));
};

var css_248z$9 = ".Drawer-module_drawer__36R2P {\n  height: 100%;\n  z-index: 1101;\n  bottom: 0;\n  position: fixed;\n  background: white;\n  min-width: 280px;\n  overflow-y: auto; }\n\n.Drawer-module_drawerOpen__euFdW {\n  overflow: hidden; }\n";
var styles$9 = {"drawer":"Drawer-module_drawer__36R2P","drawerOpen":"Drawer-module_drawerOpen__euFdW"};
styleInject(css_248z$9);

const Drawer = (props) => {
    const { children, position = 'left', onClickBackdrop } = props;
    useEffect(() => {
        document.body.classList.add(styles$9.drawerOpen);
        return () => {
            document.body.classList.remove(styles$9.drawerOpen);
        };
    }, []);
    ...
    return createPortal(React.createElement(Fragment, null,
        React.createElement("div", { className: styles$9.drawer, style: getStyles() }, children),
...
var css_248z$8 = ".FloatingActionButton-module_fab__3GwiH {\n  position: fixed;\n  bottom: 15px;\n  right: 15px;\n  z-index: 1000; }\n";
var styles$8 = {"fab":"FloatingActionButton-module_fab__3GwiH"};
...
const FloatingActionButton = (props) => {
    ...
    return (React.createElement(IconButton, { className: getCssClasses(), color: color, isActive: isActive, disabled: disabled, icon: icon, variant: VARIANT.contained, onClick: handleClick }));
};
