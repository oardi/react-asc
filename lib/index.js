...
var Checkbox = function (props) {
    ...
    return (React__default['default'].createElement("div", { className: "checkbox-container" },
        ...
        React__default['default'].createElement("input", { type: "checkbox", ref: checkboxElement, id: props.id, name: props.name, onChange: handleChange, checked: isChecked, hidden: true, value: props.value, onKeyDown: props.onKeyDown })));
};
