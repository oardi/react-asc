...
const CardBody = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: styles$g.cardBody }, rest), children));
};
...
const Drawer = (props) => {
    ...
    return createPortal(React.createElement(Fragment, null,
        React.createElement("div", { className: styles$b.drawer, style: getStyles() }, children),
