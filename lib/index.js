...
var LineChart = function (_a) {
    ...
    return (React__default['default'].createElement("canvas", { className: "chartjs", width: "400", height: "400" }));
};
...
var Checkbox = function (props) {
    var _a = React.useState(false), isChecked = _a[0], setIsChecked = _a[1];
    ...
    return (React__default['default'].createElement("div", { className: "checkbox-container" },
        ...
        React__default['default'].createElement("label", { onClick: handleClick }, props.label),
        React__default['default'].createElement("input", { type: "checkbox", ref: checkboxElement, id: props.id, name: props.name, onChange: handleChange, checked: isChecked, hidden: true, value: props.value })));
};
...
var DropDownMenu = function (_a) {
    ...
    return (React__default['default'].createElement("div", { className: getCssClasses() },
        items && !children ?
            items.map(function (item) { return React.cloneElement(item, {
                onClick: function (e) {
...
var FormInput = function (_a) {
    ...
    return (React__default['default'].createElement(React.Fragment, null,
        (type === 'text' ||
            ...
            type === 'file')
            &&
                React__default['default'].createElement("input", { id: name, name: name, type: type, className: className + (!isValid ? ' is-invalid' : ''), value: value, autoFocus: autoFocus, onChange: onChange, onBlur: onBlur, placeholder: placeholder, readOnly: readonly, disabled: disabled })
    // autoComplete="new-password"
    ,
        type === 'textarea' &&
            React__default['default'].createElement("textarea", { id: name, name: name, className: className + (!isValid ? ' is-invalid' : ''), value: value, autoFocus: autoFocus, onChange: onChange, placeholder: placeholder, rows: textareaOptions && textareaOptions.rows ? textareaOptions.rows : null, style: textareaOptions && textareaOptions.resize !== false ? null : { resize: 'none' } }),
        type === 'select' &&
            React__default['default'].createElement("select", { id: name, name: name, className: className + (!isValid ? ' is-invalid' : ''), value: value, autoFocus: autoFocus, onChange: onChange },
        ...
        type === 'checkbox' &&
            React__default['default'].createElement(Checkbox, { id: name, name: name, label: label, className: className + (!isValid ? ' is-invalid' : ''), onChange: onChange, checked: value }),
        type === 'checkboxgroup' &&
            options && options.map(function (option) {
            return React__default['default'].createElement(Checkbox, { key: option.id, label: option.label, id: option.id, name: name, value: option.value, checked: value && value.some(function (v) { return v === option.value; }), onChange: onChange });
        }),
        type === 'radio' &&
            React__default['default'].createElement(React.Fragment, null, options.map(function (option) {
                return React__default['default'].createElement("div", { className: "form-check", key: option.id },
                    React__default['default'].createElement("input", { id: option.id ? option.id : option.value, name: name, type: "radio", className: "form-check-input", onChange: onChange, value: option.value, checked: value === option.value }),
...
var GlobalModal = function (_a) {
    ...
    var _e = React.useState({}), myControls = _e[0], setMyControls = _e[1];
    React.useEffect(function () {
