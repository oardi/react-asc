...
var styles$8 = {"chip":"Chip-module_chip__1cghp","primary":"Chip-module_primary__198Dq","secondary":"Chip-module_secondary__14H0b","accent":"Chip-module_accent__2LkWr","clickable":"Chip-module_clickable__2Y4x7","shadow":"Chip-module_shadow__3TYny"};
styleInject(css_248z$8);

const Chip = (props) => {
    const { children, color = 'secondary', className, shadow, onClick } = props, rest = __rest(props, ["children", "color", "className", "shadow", "onClick"]);
    const getCssClass = () => {
        const result = [];
    ...
    return (React.createElement("div", Object.assign({ className: getCssClass() }, rest), children));
};
...
const FileInput = (props) => {
    const { id, checked, className = '', name, multiple = false, accept, disabled, onChange, readOnly } = props, rest = __rest(props, ["id", "checked", "className", "name", "multiple", "accept", "disabled", "onChange", "readOnly"]);
    ...
    return (React.createElement("input", Object.assign({ type: "file", ref: inputFileElement, className: getCssClass(), id: id, name: name, multiple: multiple, accept: accept, disabled: disabled, readOnly: readOnly, hidden: false, onChange: handleOnChange }, rest)));
};
