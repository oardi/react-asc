...
var Tabset = function (_a) {
    ...
    var _b = React.useState(null), navs = _b[0], setNavs = _b[1];
    var _c = React.useState(null), tabs = _c[0], setTabs = _c[1];
    var _d = React.useState(null), selectedTabKey = _d[0], setSelectedTabKey = _d[1];
    var getCssClasses = function () {
        var cssClasses = [];
    ...
    React.useEffect(function () {
        if (tabs && tabs.length > 0) {
            var activeTab = tabs.find(function (tab) { return tab.props.eventKey === selectedEventKey; });
            if (activeTab) {
    ...
    return (navs && tabs &&
        React__default['default'].createElement(React__default['default'].Fragment, null,
            React__default['default'].createElement("ul", { className: getCssClasses() }, navs.map(function (nav) { return (React__default['default'].createElement(TabNav, { key: nav.eventKey, eventKey: nav.eventKey, isActive: nav.eventKey === selectedTabKey, disabled: nav.disabled, onClick: function (eventKey) { return handleClickTab(eventKey); } }, nav.title)); })),
