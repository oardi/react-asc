...
const DaySelect = (props) => {
    const { className, day = new Date().getDate(), month = new Date().getMonth(), year = new Date().getFullYear(), disabled, onChange } = props;
    useEffect(() => {
        init();
    }, [month, year]);
    const init = () => {
    ...
    return (React.createElement(Select, { id: "daySelect", name: "daySelect", className: getCssClasses(), options: dayOptions, onChange: (e) => handleOnChange(parseInt(e)), disabled: disabled, value: value.toString() }));
};

const MonthSelect = (props) => {
    const months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
    const { className, value = new Date().getMonth(), disabled, onChange } = props;
    ...
    return (React.createElement(Select, { id: "monthSelect", name: "monthSelect", className: getCssClasses(), options: monthOptions, onChange: (e) => handleOnChange(parseInt(e)), disabled: disabled, value: newValue.toString() }));
};

const YearSelect = (props) => {
    const { className = '', from = 1970, to = new Date().getFullYear().toString(), value = new Date().getFullYear().toString(), disabled, onChange } = props;
    ...
    return (React.createElement(Select, { id: "yearSelect", name: "yearSelect", className: getCssClasses(), options: years, onChange: handleOnChange, disabled: disabled, value: newValue }));
};
...
const DateSelect = (props) => {
    ...
    return (React.createElement("div", { className: getCssClasses() },
        React.createElement(FormGroup, { className: "col-4" },
            React.createElement(YearSelect, { className: "form-control", value: currDate.getFullYear(), disabled: disabled, from: yearConfig === null || yearConfig === void 0 ? void 0 : yearConfig.from, to: yearConfig === null || yearConfig === void 0 ? void 0 : yearConfig.to, onChange: e => handleChange(e, DATEMODE.year) })),
        React.createElement(FormGroup, { className: "col-4" },
            React.createElement(MonthSelect, { className: "form-control", value: currDate.getMonth(), disabled: disabled, onChange: e => handleChange(e, DATEMODE.month) })),
        React.createElement(FormGroup, { className: "col-4" },
            React.createElement(DaySelect, { className: "form-control", day: currDate.getDate(), month: currDate.getMonth(), year: currDate.getFullYear(), disabled: disabled, onChange: e => handleChange(e, DATEMODE.day) }))));
};
/*
