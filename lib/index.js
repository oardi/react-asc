...
const Sidebar = (props) => {
    ...
    return (React.createElement("nav", { className: "sidebar" },
        React.createElement(List, { isHoverable: true }, menuItems.map(item => (React.createElement(React.Fragment, { key: item.id },
            React.createElement(ListItem, { onClick: (e) => !item.items && navigate(e, `/${item.path}`) },
                React.createElement(ListItemText, { primary: item.label }),
                item.items && item.items.length > 0 &&
                    React.createElement(ListItemAction, { onClick: () => handleClickItem(item) }, item.isCollapsed ? React.createElement(ChevronDownSolidIcon, null) : React.createElement(ChevronUpSolidIcon, null))),
