...
var css_248z$l = ".AppBar-module_appbar__1S8G1 {\n  padding: 0.5rem 1rem;\n  display: flex;\n  z-index: 1000; }\n  .AppBar-module_appbar__1S8G1.AppBar-module_primary__3CiO7 {\n    color: var(--primary-contrast-text);\n    background-color: var(--primary); }\n  .AppBar-module_appbar__1S8G1.AppBar-module_shadow__2c8iH {\n    box-shadow: var(--shadow); }\n";
var styles$l = {"appbar":"AppBar-module_appbar__1S8G1","primary":"AppBar-module_primary__3CiO7","shadow":"AppBar-module_shadow__2c8iH"};
...
const AppBar = (props) => {
    ...
    const getCssClasses = () => {
        const result = [];
        result.push(styles$l[color]);
        result.push(styles$l.appbar);
        shadow && result.push(styles$l['shadow']);
...
var css_248z$k = ".AppBarTitle-module_appbarTitle__3J-Z1 {\n  display: flex;\n  align-items: center;\n  padding-top: 0.3125rem;\n  padding-bottom: 0.3125rem;\n  margin-right: 1rem;\n  font-size: 1.25rem;\n  line-height: inherit;\n  white-space: nowrap; }\n  .AppBarTitle-module_appbarTitle__3J-Z1:hover {\n    cursor: pointer; }\n  .AppBarTitle-module_appbarTitle__3J-Z1 h1 {\n    margin-bottom: 0;\n    font-size: 20px;\n    font-weight: 400;\n    line-height: 30px; }\n";
var styles$k = {"appbarTitle":"AppBarTitle-module_appbarTitle__3J-Z1"};
...
const AppBarTitle = (props) => {
    ...
    const getCssClass = () => {
        const result = [];
        result.push(className);
        result.push(styles$k.appbarTitle);
        return result.filter(r => r).join(' ');
    };
...
var styles$i = {"breadcrumb":"Breadcrumb-module_breadcrumb__2BHXS","breadcrumbItem":"Breadcrumb-module_breadcrumbItem__33R5u","active":"Breadcrumb-module_active__2y_Jg"};
...
const Breadcrumb = (props) => {
    ...
    return (React.createElement(React.Fragment, null, items && items.length > 0 &&
        React.createElement("nav", null,
            React.createElement("ol", { className: getCssClasses() }, items.map((item, index) => (React.createElement("li", { key: index, className: styles$i.breadcrumbItem + (item.isActive ? ' active' : ''), onClick: () => handleClickItem(item) },
...
var css_248z$h = ".Card-module_card__31o3Z {\n  background: var(--white);\n  border-radius: var(--borderRadius); }\n  .Card-module_card__31o3Z.Card-module_shadow__2lpYq {\n    box-shadow: var(--shadow); }\n";
var styles$h = {"card":"Card-module_card__31o3Z","shadow":"Card-module_shadow__2lpYq"};
...
var css_248z$g = ".CardBody-module_cardBody__N8z-L {\n  flex: 1 1 auto;\n  min-height: 1px;\n  padding: 1.25rem; }\n";
var styles$g = {"cardBody":"CardBody-module_cardBody__N8z-L"};
...
var css_248z$f = ".CardTitle-module_cardTitle__24Amb {\n  margin-bottom: 0;\n  font-size: 1.5rem;\n  font-weight: 400;\n  line-height: 1.334;\n  letter-spacing: 0em; }\n";
var styles$f = {"cardTitle":"CardTitle-module_cardTitle__24Amb"};
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { ref: selectConainter, className: styles$4.selectContainer },
            React.createElement("div", { id: id, className: getCssClass(), onClick: () => show(), tabIndex: 0, onKeyDown: e => handleOnKeyDown(e) },
                ...
                React.createElement(SvgIcon, { className: "ml-auto" },
            ...
            isShow &&
                React.createElement(React.Fragment, null,
                    ...
                    React.createElement(Backdrop, { target: selectConainter.current, isTransparent: true, onClick: () => hide() })))));
};
...
const Sidebar = (props) => {
    ...
    return (React.createElement("nav", { className: "sidebar" },
        React.createElement(List, null, menuItems.map(item => (React.createElement(React.Fragment, { key: item.id },
            ...
            !item.isCollapsed && item.items && item.items.length > 0 && (React.createElement(List, { className: "list-level-1", key: `${item.id}-sub` }, item.items.map(subItem => (React.createElement(ListItem, { className: "list-item-level-1", key: subItem.id, onClick: (e) => navigate(e, `/${item.path}/${subItem.path}`) }, subItem.label)))))))))));
};
