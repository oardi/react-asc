...
var Breadcrumb = function (_a) {
    ...
    return (React__default['default'].createElement("nav", null,
        React__default['default'].createElement("ol", { className: getCssClasses() }, items && items.map(function (item, index) { return (React__default['default'].createElement("li", { key: index, className: "breadcrumb-item" + (item.isActive ? ' active' : ''), onClick: function () { return handleClickItem(item); } }, item.isActive ?
            item.label :
            React__default['default'].createElement("a", null, item.label))); }))));
};
...
var ModalService = /** @class */ (function () {
    ...
    ModalService.prototype.show = function (title, description, options) {
        var _this = this;
        if (this.container) {
            console.warn('only one modal instance');
        }
        if (!this.container) {
