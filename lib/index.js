...
var styles$b = {"drawer":"Drawer-module_drawer__36R2P","drawerOpen":"Drawer-module_drawerOpen__euFdW"};
...
const Drawer = (props) => {
    ...
    return createPortal(React.createElement(Fragment, null,
        React.createElement("div", { className: getCssClasses(), style: getStyles() }, children),
