...
var Breadcrumb = function (_a) {
    ...
    return (React__default['default'].createElement("nav", null,
        React__default['default'].createElement("ol", { className: getCssClasses() }, items && items.map(function (item) { return (React__default['default'].createElement("li", { className: "breadcrumb-item" + (item.isActive ? ' active' : ''), onClick: function () { return handleClickItem(item); } }, item.isActive ?
            item.label :
...
var Tabset = function (_a) {
    ...
    return (React__default['default'].createElement("div", null,
        React__default['default'].createElement("ul", { className: getCssClasses() }, children.map(function (child) { return (React__default['default'].createElement("li", { key: child.props.eventKey, className: "nav-item", role: "presentation" },
