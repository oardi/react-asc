...
var Button = function (_a) {
    ...
    return (React__default['default'].createElement("button", { type: "button", className: getCssClasses(), disabled: disabled, onClick: function (e) { return handleClick(e); }, autoFocus: autoFocus }, children));
};
...
var DropDown = function (_a) {
    var toggle = _a.toggle, children = _a.children, onToggleClick = _a.onToggleClick;
        ...
        React__default['default'].createElement("div", { ref: dropDownMenuConainter, className: "dropdown" },
            ...
            isShow &&
                React__default['default'].createElement(React__default['default'].Fragment, null,
                    React__default['default'].createElement(DropDownMenu, null, children),
...
var Tooltip = function (_a) {
    ...
    // bs-tooltip-bottom
    // bs-tooltip-right
    return (React__default['default'].createElement("div", { className: "tooltip fade bs-tooltip-top show", style: {
            position: 'absolute',
            top: '0px',
            left: '0px',
            willChange: 'transform'
        } },
        React__default['default'].createElement("div", { className: "arrow", style: { left: '45px' } }),
        React__default['default'].createElement("div", { className: "tooltip-inner" }, children)));
};
