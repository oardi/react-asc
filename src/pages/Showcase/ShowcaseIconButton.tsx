...
const ShowcaseIconButtonBase = ({ settingValues, setSettingsControls }: IShowcaseBaseProps<IIconButtonProps>) => {
...
export const ShowcaseIconButton = withOptions<IIconButtonProps>(ShowcaseIconButtonBase, {
	color: COLOR.primary,
