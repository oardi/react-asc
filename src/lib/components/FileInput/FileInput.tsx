...
export const FileInput = (props: IFileInputProps): React.JSX.Element => {
	const {
		id,
		className,
		children,
	...
	const inputFileElement: React.RefObject<HTMLInputElement | null> = useRef<HTMLInputElement>(null);
