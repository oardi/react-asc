...
export const CssTransition = (props: ICssTransitionProps): React.JSX.Element => {
	...
	const transitionConainter: React.RefObject<HTMLDivElement | null> = useRef<HTMLDivElement>(null);
