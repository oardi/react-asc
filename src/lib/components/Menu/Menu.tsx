...
export const Menu = (props: IMenuProps): React.JSX.Element => {
	const { toggle, children, className, open, menuPosition, onClickBackdrop, ...rest } = props;

	const menuContainer: React.RefObject<HTMLDivElement | null> = useRef<HTMLDivElement | null>(null);
	const toggleContainerRef: React.RefObject<HTMLDivElement | null> = useRef<HTMLDivElement | null>(null);
