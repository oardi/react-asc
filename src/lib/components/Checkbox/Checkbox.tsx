...
export const Checkbox = (props: ICheckboxProps): React.JSX.Element => {
	...
	const checkboxElement: React.RefObject<HTMLInputElement | null> = useRef<HTMLInputElement>(null);
	...
	return (
		<div className={styles.checkboxContainer}>
			<IconButton className={getCssClasses()} onClick={handleClick} icon={getIcon()} disabled={disabled || readOnly} />
