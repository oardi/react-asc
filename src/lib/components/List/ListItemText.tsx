...
export const ListItemText = ({ primary, secondary, ...rest }: IListItemTextProps): React.JSX.Element => {
...
const ListItemTextPrimary = ({ children }: React.ComponentProps<'div'>): React.JSX.Element => (
	<div className="list-item-text-primary">{children}</div>
);

const ListItemTextSecondary = ({ children }: React.ComponentProps<'div'>): React.JSX.Element => (
