...
const CardPageBase = ({ settingValues, setSettingsControls }: IShowcaseBaseProps<ICardPageBaseProps>): React.JSX.Element => {
	useEffect(() => {
		setSettingsControls({
...
export const CardPage: () => React.JSX.Element = withOptions<ICardPageBaseProps>(
	CardPageBase,
	{
		showImage: false,
		showSubtitle: false,
