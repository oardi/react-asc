...
import type { IAutoCompleteProps, ISelectOption } from 'src/lib';
import { AutoComplete, FormControl, snackbarService } from 'src/lib';
...
const AutoCompletePageBase = ({ settingValues, setSettingsControls }: IShowcaseBaseProps<IAutoCompleteProps>): React.JSX.Element => {
...
export const AutoCompletePage: () => React.JSX.Element = withOptions<IAutoCompleteProps>(
