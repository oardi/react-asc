...
import type { ITreeItemProps } from 'src/lib';
import { FormControl, snackbarService, TreeItem, TreeView, Typography } from 'src/lib';
import type { IShowcaseBaseProps } from './components';
import { withOptions } from './components';

const TreeViewPageBase = ({ settingValues, setSettingsControls }: IShowcaseBaseProps<ITreeItemProps>): React.JSX.Element => {
	useEffect(() => {
		setSettingsControls({
...
export const TreeViewPage: () => React.JSX.Element = withOptions(
	TreeViewPageBase,
	{
		isSelectable: false,
	},
