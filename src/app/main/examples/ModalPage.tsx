...
const ModalPageBase = ({ settingValues, setSettingsControls }: IShowcaseBaseProps<IModalProps>): React.JSX.Element => {
	useEffect(() => {
		setSettingsControls({
...
export const ModalPage: () => React.JSX.Element = withOptions(ModalPageBase, undefined, 'ModalPageBase');
