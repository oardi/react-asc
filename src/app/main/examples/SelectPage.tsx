...
import type { ISelectProps } from 'src/lib';
import { CheckSolidIcon, FormControl, Icon, Select, snackbarService } from 'src/lib';
import type { IShowcaseBaseProps } from './components';
import { withOptions } from './components';

const SelectPageBase = ({ settingValues, setSettingsControls }: IShowcaseBaseProps<ISelectProps>): React.JSX.Element => {
...
export const SelectPage: () => React.JSX.Element = withOptions<ISelectProps>(
	SelectPageBase,
	{
