...
import type { IStepperProps } from 'src/lib';
import { FormControl, Step, Stepper, snackbarService } from 'src/lib';
import type { IShowcaseBaseProps } from './components';
import { withOptions } from './components';

const CLASSNAME: string = 'StepperPageBase';
const StepperPageBase = ({ settingValues, setSettingsControls }: IShowcaseBaseProps<IStepperProps>): React.JSX.Element => {
...
export const StepperPage: () => React.JSX.Element = withOptions<IStepperProps>(
	StepperPageBase,
	{
		isLinear: false,
		showLabel: true,
